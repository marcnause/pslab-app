...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1058181045;
...
fn wire__crate__api__simple__query_scpi_binary_rust_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "query_scpi_binary_rust",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::simple::query_scpi_binary_rust(
                        api_command,
                        api_timeout_ms,
                    ))?;
                    std::result::Result::Ok(output_ok)
...
fn wire__crate__api__simple__send_scpi_rust_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok = Ok::<_, ()>({
                    crate::api::simple::send_scpi_rust(api_command);
                })?;
                std::result::Result::Ok(output_ok)
            })())
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        10 => {
            wire__crate__api__simple__query_scpi_binary_rust_impl(port, ptr, rust_vec_len, data_len)
        }
        11 => wire__crate__api__simple__read_data_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__audio__start_microphone_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__audio__stop_microphone_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__simple__wifi_connect_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__simple__wifi_read_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        12 => wire__crate__api__simple__read_web_data_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__simple__send_scpi_rust_impl(ptr, rust_vec_len, data_len),
        14 => wire__crate__api__simple__set_baud_rate_impl(ptr, rust_vec_len, data_len),
        15 => wire__crate__api__simple__set_dtr_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__simple__set_rts_impl(ptr, rust_vec_len, data_len),
        20 => wire__crate__api__simple__wifi_disconnect_impl(ptr, rust_vec_len, data_len),
        22 => wire__crate__api__simple__wifi_write_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__simple__write_data_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
